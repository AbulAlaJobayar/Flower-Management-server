...
const productSchema = new Schema<TProduct>({
    ...
    category: {
        type: String, required: [true, 'please provide flower category']
    },
    size: {
        type: String, required: [true, 'please provide flower size']
    },
    fragrance: {
        type: String, required: [true, 'please provide flower fragrance']
    },
    image: {
